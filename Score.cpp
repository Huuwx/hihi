...
public:
    ...
    static double getMinAvg(vector<Score*> vt){
        ...
        for(int i=1;i<vt.size();i++){
            if(vt[i]->avgPoint()<min) min=vt[i]->avgPoint();
        }
        return min;
    }
    bool isPass(){
    ...
    static double getMaxPointA(vector<Score*> vt){
        ...
        for(int i=1;i<vt.size();i++){
            if(vt[i]->pointA()>max) max=vt[i]->pointA();
        }
        return max;
    }
    static double getMaxPointB(vector<Score*> vt){
        ...
        for(int i=1;i<vt.size();i++){
            if(vt[i]->pointB()>max) max=vt[i]->pointB();
        }
        return max;
    }
    static double getMaxPointC(vector<Score*> vt){
        ...
        for(int i=1;i<vt.size();i++){
            if(vt[i]->pointC()>max) max=vt[i]->pointC();
        }
        return max;
    }
    static double getMaxPointD(vector<Score*> vt){
        ...
        for(int i=1;i<vt.size();i++){
            if(vt[i]->pointD()>max) max=vt[i]->pointD();
        }
        return max;
    }
};
